...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('admin_calendar_calendarevent', (
            ...
            ('image_original', self.gf('django.db.models.fields.files.ImageField')(max_length=100, blank=True)),
            ('type', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('admin_calendar', ['CalendarEvent'])


    def backwards(self, orm):
        
        # Deleting model 'CalendarEvent'
        db.delete_table('admin_calendar_calendarevent')


    models = {
        'admin_calendar.calendarevent': {
