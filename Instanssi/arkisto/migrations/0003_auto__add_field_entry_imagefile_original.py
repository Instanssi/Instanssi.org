...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Entry.imagefile_original'
        db.add_column('arkisto_entry', 'imagefile_original', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Entry.imagefile_original'
        db.delete_column('arkisto_entry', 'imagefile_original')
