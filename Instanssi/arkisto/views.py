            ...
            entries_out.append(
                {
                    ...
                    "entry_image_thumbnail": get_url(e.imagefile_thumbnail.url)
                    if e.imagefile_thumbnail
                    else None,
                    "entry_image_medium": get_url(e.imagefile_medium.url) if e.imagefile_medium else None,
                    "entry_image_original": get_url(e.imagefile_original.url)
...
def event(request, event_id):
    ...
    competitions_q = Competition.objects.filter(
        event=event_obj, active=True, hide_from_archive=False
    ).order_by("name")
