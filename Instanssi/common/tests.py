...
class YoutubeUrlTestCase(TestCase):
    ...
    def test_long_form(self):
        self.assertEqual(
            parse_youtube_video_id("http://www.youtube.com/watch?v=dbh4re56u4&feature=feedu"),
            "dbh4re56u4",
        )
    ...
    def test_short_embed_form(self):
        self.assertEqual(
            parse_youtube_video_id("http://www.youtube.com/v/egv5yber5yre5?version=3&amp;hl=en_US"),
            "egv5yber5yre5",
        )
