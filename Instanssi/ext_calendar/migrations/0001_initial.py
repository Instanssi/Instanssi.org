...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ext_calendar_calendarevent', (
            ...
            ('linked_compo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['kompomaatti.Compo'], null=True, blank=True)),
            ('linked_programme', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ext_programme.ProgrammeEvent'], null=True, blank=True)),
        ))
    ...
    models = {
        ...
        'ext_calendar.calendarevent': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'linked_compo': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['kompomaatti.Compo']", 'null': 'True', 'blank': 'True'}),
            'linked_programme': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ext_programme.ProgrammeEvent']", 'null': 'True', 'blank': 'True'}),
