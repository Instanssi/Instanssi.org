...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProgrammeEvent.github_url'
        db.add_column('ext_programme_programmeevent', 'github_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProgrammeEvent.github_url'
        db.delete_column('ext_programme_programmeevent', 'github_url')
