...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProgrammeEvent.icon2_original'
        db.add_column('ext_programme_programmeevent', 'icon2_original',
                      self.gf('django.db.models.fields.files.ImageField')(default=u'', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProgrammeEvent.icon2_original'
        db.delete_column('ext_programme_programmeevent', 'icon2_original')
