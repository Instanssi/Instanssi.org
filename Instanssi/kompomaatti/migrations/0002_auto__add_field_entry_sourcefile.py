...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Entry.sourcefile'
        db.add_column('kompomaatti_entry', 'sourcefile', self.gf('django.db.models.fields.files.FileField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Entry.sourcefile'
        db.delete_column('kompomaatti_entry', 'sourcefile')
