...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('kompomaatti_event', 'archived', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Event.archived'
        db.delete_column('kompomaatti_event', 'archived')
