...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Compo.source_formats'
        db.add_column('kompomaatti_compo', 'source_formats', self.gf('django.db.models.fields.CharField')(default='zip|7z|gz|bz2', max_length=128), keep_default=False)

        # Changing field 'Compo.formats'
        db.alter_column('kompomaatti_compo', 'formats', self.gf('django.db.models.fields.CharField')(max_length=128))


    def backwards(self, orm):
        
        # Deleting field 'Compo.source_formats'
        db.delete_column('kompomaatti_compo', 'source_formats')
