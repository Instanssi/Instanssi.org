...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Entry.archive_score'
        db.add_column('kompomaatti_entry', 'archive_score', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Entry.archive_score'
        db.delete_column('kompomaatti_entry', 'archive_score')
