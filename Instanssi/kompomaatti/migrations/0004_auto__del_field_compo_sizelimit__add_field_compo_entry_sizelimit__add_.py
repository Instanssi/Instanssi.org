...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Compo.sizelimit'
        db.delete_column('kompomaatti_compo', 'sizelimit')

        # Adding field 'Compo.entry_sizelimit'
        db.add_column('kompomaatti_compo', 'entry_sizelimit', self.gf('django.db.models.fields.IntegerField')(default=134217728), keep_default=False)

        # Adding field 'Compo.source_sizelimit'
        db.add_column('kompomaatti_compo', 'source_sizelimit', self.gf('django.db.models.fields.IntegerField')(default=134217728), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Compo.sizelimit'
        db.add_column('kompomaatti_compo', 'sizelimit', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Deleting field 'Compo.entry_sizelimit'
        db.delete_column('kompomaatti_compo', 'entry_sizelimit')

        # Deleting field 'Compo.source_sizelimit'
        db.delete_column('kompomaatti_compo', 'source_sizelimit')
