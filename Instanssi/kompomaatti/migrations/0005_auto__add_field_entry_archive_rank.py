...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Entry.archive_rank'
        db.add_column('kompomaatti_entry', 'archive_rank', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Entry.archive_rank'
        db.delete_column('kompomaatti_entry', 'archive_rank')
