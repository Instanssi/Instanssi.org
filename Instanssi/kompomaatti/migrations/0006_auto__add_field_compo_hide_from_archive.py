...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Compo.hide_from_archive'
        db.add_column('kompomaatti_compo', 'hide_from_archive', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Compo.hide_from_archive'
        db.delete_column('kompomaatti_compo', 'hide_from_archive')
