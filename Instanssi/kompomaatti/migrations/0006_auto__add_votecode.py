...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('kompomaatti_votecode', (
            ...
            ('associated_to', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 1, 24, 5, 24, 50, 841000))),
        ))
    ...
    models = {
        ...
        'kompomaatti.votecode': {
            ...
            'time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 24, 5, 24, 50, 841000)'})
        }
    }
