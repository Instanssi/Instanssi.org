...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'VoteCode', fields ['key']
        db.create_unique('kompomaatti_votecode', ['key'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'VoteCode', fields ['key']
        db.delete_unique('kompomaatti_votecode', ['key'])
    ...
    models = {
        ...
        'kompomaatti.votecode': {
            ...
            'time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 28, 1, 35, 36, 21744)'})
        }
    }
