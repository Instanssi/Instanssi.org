...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VoteCodeRequest.event'
        db.add_column('kompomaatti_votecoderequest', 'event',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['kompomaatti.Event'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VoteCodeRequest.event'
        db.delete_column('kompomaatti_votecoderequest', 'event_id')
