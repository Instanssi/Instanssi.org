...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VoteCode.time'
        db.alter_column('kompomaatti_votecode', 'time', self.gf('django.db.models.fields.DateTimeField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'VoteCode.time'
        db.alter_column('kompomaatti_votecode', 'time', self.gf('django.db.models.fields.DateTimeField')())
