...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CompetitionParticipation'
        db.create_table('kompomaatti_competitionparticipation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('competition', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['kompomaatti.Competition'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('score', self.gf('django.db.models.fields.FloatField')(blank=True)),
        ))
        db.send_create_signal('kompomaatti', ['CompetitionParticipation'])

        # Adding model 'Competition'
        db.create_table('kompomaatti_competition', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['kompomaatti.Event'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('participation_end', self.gf('django.db.models.fields.DateTimeField')()),
            ('start', self.gf('django.db.models.fields.DateTimeField')()),
            ('end', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('score_type', self.gf('django.db.models.fields.CharField')(max_length=8)),
            ('score_sort', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('show_results', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('kompomaatti', ['Competition'])


    def backwards(self, orm):
        # Deleting model 'CompetitionParticipation'
        db.delete_table('kompomaatti_competitionparticipation')

        # Deleting model 'Competition'
        db.delete_table('kompomaatti_competition')
    ...
    models = {
        ...
        'kompomaatti.competitionparticipation': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'score': ('django.db.models.fields.FloatField', [], {'blank': 'True'}),
