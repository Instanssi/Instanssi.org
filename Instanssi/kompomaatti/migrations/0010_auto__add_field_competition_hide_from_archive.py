...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Competition.hide_from_archive'
        db.add_column('kompomaatti_competition', 'hide_from_archive',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Competition.hide_from_archive'
        db.delete_column('kompomaatti_competition', 'hide_from_archive')
