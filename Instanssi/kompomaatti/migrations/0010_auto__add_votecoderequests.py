...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'VoteCodeRequests'
        db.create_table('kompomaatti_votecoderequests', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True)),
            ('text', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('kompomaatti', ['VoteCodeRequests'])


    def backwards(self, orm):
        
        # Deleting model 'VoteCodeRequests'
        db.delete_table('kompomaatti_votecoderequests')
    ...
    models = {
        ...
        'kompomaatti.votecoderequests': {
            'Meta': {'object_name': 'VoteCodeRequests'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
