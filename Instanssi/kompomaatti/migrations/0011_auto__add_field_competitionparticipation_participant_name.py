...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompetitionParticipation.participant_name'
        db.add_column('kompomaatti_competitionparticipation', 'participant_name',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompetitionParticipation.participant_name'
        db.delete_column('kompomaatti_competitionparticipation', 'participant_name')
