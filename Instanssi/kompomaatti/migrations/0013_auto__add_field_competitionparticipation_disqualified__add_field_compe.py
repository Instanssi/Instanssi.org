...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompetitionParticipation.disqualified'
        db.add_column('kompomaatti_competitionparticipation', 'disqualified',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'CompetitionParticipation.disqualified_reason'
        db.add_column('kompomaatti_competitionparticipation', 'disqualified_reason',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompetitionParticipation.disqualified'
        db.delete_column('kompomaatti_competitionparticipation', 'disqualified')

        # Deleting field 'CompetitionParticipation.disqualified_reason'
        db.delete_column('kompomaatti_competitionparticipation', 'disqualified_reason')
