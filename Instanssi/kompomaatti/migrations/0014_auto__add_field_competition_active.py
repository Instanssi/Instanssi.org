...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Competition.active'
        db.add_column('kompomaatti_competition', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Competition.active'
        db.delete_column('kompomaatti_competition', 'active')
