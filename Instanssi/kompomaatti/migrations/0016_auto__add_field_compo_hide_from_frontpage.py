...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Compo.hide_from_frontpage'
        db.add_column('kompomaatti_compo', 'hide_from_frontpage',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Compo.hide_from_frontpage'
        db.delete_column('kompomaatti_compo', 'hide_from_frontpage')
