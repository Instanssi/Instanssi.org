...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Compo.thumbnail_pref'
        db.add_column('kompomaatti_compo', 'thumbnail_pref',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Compo.thumbnail_pref'
        db.delete_column('kompomaatti_compo', 'thumbnail_pref')
    ...
    models = {
        ...
        'kompomaatti.compo': {
            ...
            'thumbnail_pref': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
