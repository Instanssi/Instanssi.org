...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Compo.image_formats'
        db.add_column('kompomaatti_compo', 'image_formats',
                      self.gf('django.db.models.fields.CharField')(default='png|jpg', max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Compo.image_formats'
        db.delete_column('kompomaatti_compo', 'image_formats')
    ...
    models = {
        ...
        'kompomaatti.compo': {
            ...
            'hide_from_archive': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'hide_from_frontpage': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image_formats': ('django.db.models.fields.CharField', [], {'default': "'png|jpg'", 'max_length': '128'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            ...
            'thumbnail_pref': ('django.db.models.fields.IntegerField', [], {'default': '2'}),
