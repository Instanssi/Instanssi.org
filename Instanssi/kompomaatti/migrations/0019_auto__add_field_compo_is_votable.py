...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Compo.is_votable'
        db.add_column('kompomaatti_compo', 'is_votable',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Compo.is_votable'
        db.delete_column('kompomaatti_compo', 'is_votable')
    ...
    models = {
        ...
        'kompomaatti.compo': {
            ...
            'is_votable': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
