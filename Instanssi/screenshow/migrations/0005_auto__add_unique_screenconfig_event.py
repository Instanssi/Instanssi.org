...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ScreenConfig', fields ['event']
        db.create_unique('screenshow_screenconfig', ['event_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ScreenConfig', fields ['event']
        db.delete_unique('screenshow_screenconfig', ['event_id'])
