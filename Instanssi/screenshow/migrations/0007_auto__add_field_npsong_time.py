...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NPSong.time'
        db.add_column('screenshow_npsong', 'time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 2, 11, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NPSong.time'
        db.delete_column('screenshow_npsong', 'time')
