    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "params",
                    models.TextField(default=None, null=True, verbose_name="Lähetysparametrit"),
                ),
                (
                    "content",
                    models.TextField(default=None, null=True, verbose_name="Kuitin sisältö"),
                ),
            ],
            options={
                "verbose_name": "kuitti",
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=255,
                        verbose_name="Tuotteen nimi",
                    ),
                ),
                (
                    "description",
                    models.TextField(help_text="Tuotteen pitkä kuvaus.", verbose_name="Tuotteen kuvaus"),
                ),
                (
                    "price",
                    models.DecimalField(
                ...
                (
                    ...
                    models.IntegerField(
                        ...
                        verbose_name="Kappaletta saatavilla",
                    ),
                ),
                (
                    "available",
                ...
                (
                    ...
                    models.IntegerField(
                        ...
                        verbose_name="Maksimi per tilaus",
                    ),
                ),
                (
                    "sort_index",
                ...
                (
                    ...
                    models.BooleanField(
                        ...
                        verbose_name="Tuote on lipputuote",
                    ),
                ),
                (
                    "event",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "item",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="store.StoreItem"),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=255,
                        verbose_name="Palvelutunniste",
                    ),
                ),
                (
                    "time_created",
                    models.DateTimeField(blank=True, null=True, verbose_name="Luontiaika"),
                ),
                (
                    "time_paid",
                    models.DateTimeField(blank=True, null=True, verbose_name="Maksun varmistumisaika"),
                ),
                (
                    "time_pending",
                    models.DateTimeField(blank=True, null=True, verbose_name="Maksun maksuaika"),
                ),
                (
                    "time_cancelled",
                    models.DateTimeField(blank=True, null=True, verbose_name="Peruutusaika"),
                ),
                (
                    "payment_method_name",
                    models.CharField(
                ...
                (
                    "email",
                    models.EmailField(
                        help_text="Sähköpostiosoitteen on oltava toimiva, sillä liput ja tuotteiden lunastukseen tarvittavat koodit lähetetään sinne.",
                        max_length=255,
                ...
                (
                    "telephone",
                    models.CharField(blank=True, max_length=64, verbose_name="Puhelinnumero"),
                ),
                (
                    "mobile",
                    models.CharField(blank=True, max_length=64, verbose_name="Matkapuhelin"),
                ),
                (
                    "street",
                    models.CharField(
                ...
                (
                    "country",
                    django_countries.fields.CountryField(default="FI", max_length=2, verbose_name="Maa"),
                ),
                (
                    "information",
                    models.TextField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "key",
                    models.CharField(
                        help_text="Lippuavain", max_length=40, unique=True, verbose_name="Avain"
                    ),
                ),
                (
                    "time_delivered",
                    models.DateTimeField(blank=True, null=True, verbose_name="Toimitusaika"),
                ),
                (
                    "purchase_price",
                    models.DecimalField(
                ...
                (
                    ...
                    models.DecimalField(
                        ...
                        max_digits=5,
                        verbose_name="Tuotteen alkuperäinen hinta",
                    ),
                ),
                (
                    "item",
