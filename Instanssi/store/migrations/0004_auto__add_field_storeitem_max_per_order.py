...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StoreItem.max_per_order'
        db.add_column('store_storeitem', 'max_per_order',
                      self.gf('django.db.models.fields.IntegerField')(default=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StoreItem.max_per_order'
        db.delete_column('store_storeitem', 'max_per_order')
