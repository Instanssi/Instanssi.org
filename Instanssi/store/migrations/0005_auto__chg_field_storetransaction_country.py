...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'StoreTransaction.country'
        db.alter_column('store_storetransaction', 'country', self.gf('django_countries.fields.CountryField')(max_length=2))

    def backwards(self, orm):

        # Changing field 'StoreTransaction.country'
        db.alter_column('store_storetransaction', 'country', self.gf('django.db.models.fields.CharField')(max_length=2))
