...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StoreTransaction.key'
        db.add_column('store_storetransaction', 'key',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=40),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StoreTransaction.key'
        db.delete_column('store_storetransaction', 'key')
