...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'StoreTransaction', fields ['key']
        db.create_unique('store_storetransaction', ['key'])


    def backwards(self, orm):
        # Removing unique constraint on 'StoreTransaction', fields ['key']
        db.delete_unique('store_storetransaction', ['key'])
