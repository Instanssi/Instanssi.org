...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StoreTransaction.information'
        db.add_column('store_storetransaction', 'information',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StoreTransaction.information'
        db.delete_column('store_storetransaction', 'information')
