...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TransactionItem.key'
        db.add_column(u'store_transactionitem', 'key',
                      self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=40),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TransactionItem.key'
        db.delete_column(u'store_transactionitem', 'key')
