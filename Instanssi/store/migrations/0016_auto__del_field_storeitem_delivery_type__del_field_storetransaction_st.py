...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'StoreItem.delivery_type'
        db.delete_column(u'store_storeitem', 'delivery_type')

        # Deleting field 'StoreTransaction.status'
        db.delete_column(u'store_storetransaction', 'status')

        # Adding field 'StoreTransaction.time_cancelled'
        db.add_column(u'store_storetransaction', 'time_cancelled',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'TransactionItem.delivered'
        db.delete_column(u'store_transactionitem', 'delivered')

        # Adding field 'TransactionItem.time_delivered'
        db.add_column(u'store_transactionitem', 'time_delivered',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'StoreItem.delivery_type'
        db.add_column(u'store_storeitem', 'delivery_type',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'StoreTransaction.status'
        db.add_column(u'store_storetransaction', 'status',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'StoreTransaction.time_cancelled'
        db.delete_column(u'store_storetransaction', 'time_cancelled')

        # Adding field 'TransactionItem.delivered'
        db.add_column(u'store_transactionitem', 'delivered',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'TransactionItem.time_delivered'
        db.delete_column(u'store_transactionitem', 'time_delivered')
