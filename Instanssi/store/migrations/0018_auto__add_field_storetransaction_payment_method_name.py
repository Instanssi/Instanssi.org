...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StoreTransaction.payment_method_name'
        db.add_column(u'store_storetransaction', 'payment_method_name',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StoreTransaction.payment_method_name'
        db.delete_column(u'store_storetransaction', 'payment_method_name')
    ...
    models = {
        ...
        u'store.storetransaction': {
            ...
            'payment_method_name': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '32'}),
