...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StoreTransaction.time_pending'
        db.add_column(u'store_storetransaction', 'time_pending',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StoreTransaction.time_pending'
        db.delete_column(u'store_storetransaction', 'time_pending')
