...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StoreItem.sort_index'
        db.add_column(u'store_storeitem', 'sort_index',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StoreItem.sort_index'
        db.delete_column(u'store_storeitem', 'sort_index')
    ...
    models = {
        ...
        u'store.storeitem': {
            ...
            'sort_index': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
        u'store.storetransaction': {
            ...
            'payment_method_name': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '32', 'blank': 'True'}),
            ...
            'time_pending': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
