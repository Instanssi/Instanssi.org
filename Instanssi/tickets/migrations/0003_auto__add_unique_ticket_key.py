...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Ticket', fields ['key']
        db.create_unique('tickets_ticket', ['key'])


    def backwards(self, orm):
        # Removing unique constraint on 'Ticket', fields ['key']
        db.delete_unique('tickets_ticket', ['key'])
