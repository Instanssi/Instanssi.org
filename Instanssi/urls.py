...
urlpatterns = patterns('',
    ...
    url(r'^2013demo/', include('Instanssi.main2013.urls', namespace="main2013")),
    ...
    url(r'^manage/(?P<sel_event_id>\d+)/calendar/', include('Instanssi.admin_calendar.urls', namespace='manage-calendar')),
