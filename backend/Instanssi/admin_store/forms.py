...
class StoreItemForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            Div(
                HTML(
                    "Tuotteen alityypit alla. Täytä kentät jotka tarvitset. Mikäli kentät loppuvat kesken, "
                    "tallenna välillä ja muokkaa."
                ),
                css_class="ctrlHolder",
            ),
        )
...
class TaItemExportForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["event"].required = True
        self.helper = FormHelper()
        self.helper.layout = Layout(Fieldset("Vie", "event", ButtonHolder(Submit("submit", "Vie"))))
