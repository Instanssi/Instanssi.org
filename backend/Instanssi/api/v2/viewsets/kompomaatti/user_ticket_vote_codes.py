...
class UserTicketVoteCodeViewSet(CreateModelMixin, RetrieveModelMixin, ListModelMixin, GenericViewSet):
    """
    ...
    def get_queryset(self):
        ...
        return TicketVoteCode.objects.filter(event_id=event_id, associated_to=self.request.user)
