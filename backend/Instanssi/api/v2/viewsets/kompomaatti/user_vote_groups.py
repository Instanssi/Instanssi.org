...
class UserVoteGroupViewSet(CreateModelMixin, RetrieveModelMixin, ListModelMixin, GenericViewSet):
    """
    ...
    def get_queryset(self):
        ...
        return VoteGroup.objects.filter(compo__event_id=event_id, user=self.request.user)
