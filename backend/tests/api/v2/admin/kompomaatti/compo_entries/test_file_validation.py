...
@pytest.mark.django_db
def test_staff_invalid_image_file_format_rejected(
...
@pytest.mark.django_db
def test_staff_entry_file_too_large_rejected(staff_api_client, open_compo, base_user, source_zip, image_png):
...
@pytest.mark.django_db
def test_staff_image_not_allowed_but_provided_rejected(
...
@pytest.mark.django_db
def test_staff_multiple_file_errors_aggregated(staff_api_client, open_compo, base_user, test_image):
...
@pytest.mark.django_db
def test_staff_entry_copied_to_image_when_configured(
    staff_api_client, open_compo, base_user, source_zip, image_png
):
