...
@pytest.mark.django_db
def test_ticket_vote_code_event_from_url_overrides_request_body_on_create(
...
@pytest.mark.django_db
def test_ticket_vote_code_event_is_readonly_on_update(staff_api_client, ticket_vote_code, other_event):
