...
@pytest.mark.django_db
def test_store_item_variants_filter_by_event(variant_staff_api_client, variant_item, store_item_variant):
...
@pytest.mark.django_db
def test_store_item_variants_search_by_name(variant_staff_api_client, variant_item, store_item_variant):
