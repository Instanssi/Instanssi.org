...
@pytest.mark.django_db
def test_uploads_filter_by_event(staff_api_client, event, uploaded_file, other_event_uploaded_file):
...
@pytest.mark.django_db
def test_uploads_filter_by_user(staff_api_client, uploaded_file, staff_user):
