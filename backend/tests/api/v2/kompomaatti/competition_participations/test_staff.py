...
@pytest.mark.django_db
def test_filter_by_competition(staff_api_client, competition, competition_participation):
...
@pytest.mark.django_db
def test_filter_by_user(staff_api_client, base_user, competition_participation):
...
@pytest.mark.django_db
def test_staff_can_always_see_score_rank(staff_api_client, started_competition_participation):
...
@pytest.mark.django_db
def test_cannot_create_participation_for_other_event_competition(
