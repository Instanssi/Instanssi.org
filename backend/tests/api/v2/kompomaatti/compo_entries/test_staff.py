...
@pytest.mark.django_db
def test_filter_by_user(staff_api_client, base_user, editable_compo_entry):
...
@pytest.mark.django_db
def test_staff_can_always_see_score_rank(staff_api_client, votable_compo_entry):
