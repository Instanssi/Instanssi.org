...
@pytest.mark.django_db
def test_public_cannot_see_entry_score_rank_before_results_shown(api_client, votable_compo_entry):
...
@pytest.mark.django_db
def test_public_can_see_entry_score_rank_after_results_shown(api_client, votable_compo_entry):
