...
@pytest.mark.django_db
def test_unauthorized_cannot_see_entry_score_rank_before_results_shown(auth_client, votable_compo_entry):
...
@pytest.mark.django_db
def test_unauthorized_can_see_entry_score_rank_after_results_shown(auth_client, votable_compo_entry):
