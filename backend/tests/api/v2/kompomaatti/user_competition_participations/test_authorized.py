...
@pytest.mark.django_db
def test_filter_by_competition(auth_client, competition_participation):
...
@pytest.mark.django_db
def test_cannot_create_participation_for_other_event_competition(auth_client, event, other_competition):
