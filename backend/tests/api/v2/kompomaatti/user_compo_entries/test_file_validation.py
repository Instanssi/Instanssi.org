...
def test_invalid_entry_file_format_rejected(auth_client, open_compo, source_zip, image_png):
...
@pytest.mark.django_db
def test_invalid_source_file_format_rejected(auth_client, open_compo, entry_zip, image_png):
...
@pytest.mark.django_db
def test_invalid_image_file_format_rejected(auth_client, open_compo, entry_zip, source_zip, test_image):
...
@pytest.mark.django_db
def test_entry_file_too_large_rejected(auth_client, open_compo, source_zip, image_png):
...
@pytest.mark.django_db
def test_image_required_but_missing_rejected(auth_client, open_compo, entry_zip, source_zip):
...
@pytest.mark.django_db
def test_image_not_allowed_but_provided_rejected(auth_client, open_compo, entry_zip, source_zip, image_png):
...
@pytest.mark.django_db
def test_multiple_file_errors_aggregated(auth_client, open_compo, test_image):
...
@pytest.mark.django_db
def test_entry_copied_to_image_when_configured(auth_client, open_compo, source_zip, image_png):
