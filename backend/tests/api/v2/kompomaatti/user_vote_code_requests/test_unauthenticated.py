...
def test_unauthenticated_vote_code_requests_list(api_client, event, method, status):
...
def test_unauthenticated_vote_code_requests_detail(api_client, vote_code_request, method, status):
