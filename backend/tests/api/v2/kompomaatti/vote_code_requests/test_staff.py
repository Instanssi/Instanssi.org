...
@pytest.mark.django_db
def test_event_from_url_overrides_request_body_on_create(staff_api_client, event, other_event, base_user):
...
@pytest.mark.django_db
def test_event_is_readonly_on_update(staff_api_client, vote_code_request, other_event):
