...
@pytest.mark.django_db
def test_programme_events_filter_by_event(staff_api_client, event, programme_event):
...
@pytest.mark.django_db
def test_programme_events_filter_by_active(staff_api_client, programme_event, inactive_programme_event):
