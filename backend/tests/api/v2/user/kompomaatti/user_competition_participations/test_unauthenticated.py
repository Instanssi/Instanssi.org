...
def test_unauthenticated_participations_list(api_client, event, method, status):
...
def test_unauthenticated_participations_detail(api_client, competition_participation, method, status):
