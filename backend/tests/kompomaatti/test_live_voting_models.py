...
@pytest.mark.django_db
@freeze_time("2025-01-15T21:00:00Z")
def test_is_voting_open_past_voting_end(live_voting_compo, live_voting_state):
    """When voting_end has passed, voting is closed even if state.voting_open=True."""
    live_voting_state.voting_open = True
    live_voting_state.save()
